"""
Django settings for homepage2_back project.
...
ALLOWED_HOSTS = ["localhost", "13.52.122.155", "jimpollaro.com"]
...
ROOT_URLCONF = "homepage2_back.urls"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://hbl@127.0.0.1:6379/0",
        "OPTIONS": {
